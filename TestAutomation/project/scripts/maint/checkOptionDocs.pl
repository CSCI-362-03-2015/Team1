...
open(F, "/home/mister/Documents/362/Git/theMonkeyCatfishCoalition/TestAutomation/project/src/or/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/home/mister/Documents/362/Git/theMonkeyCatfishCoalition/TestAutomation/project/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/home/mister/Documents/362/Git/theMonkeyCatfishCoalition/TestAutomation/project/doc/tor.1.txt") or die;
while (<F>) {
